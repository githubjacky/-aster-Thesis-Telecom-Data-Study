...
\textbf{(a) Outgoing Total Duration}\\
\includesvg[scale=0.57, inkscapepath=svgsubdir]{figures/outcome_path_smartphone_change/out_total_duration.svg}

\vspace{0.3cm}
\textbf{(b) Incoming Total Duration}\\
\includesvg[scale=0.57, inkscapepath=svgsubdir]{figures/outcome_path_smartphone_change/in_total_duration.svg}
