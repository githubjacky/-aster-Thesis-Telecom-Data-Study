...
\includegraphics[scale=0.3]{figures/rg_compare.png}
\includegraphics[scale=0.3]{figures/entropy_compare.png}
\includegraphics[scale=0.3]{figures/ecc_compare.png}
...
\]
We haven't seen this correction applied in previous studies, but we believe it's necessary for small sample (phone users who have limited CDRs) to apply Bessel's correction since $(r_c)_{i, m}$ is the sample mean.
